<script>
    $(document).ready(function() {
        $('.btn-del-ad-article').click(function() {
            var id = $(this).data('id');
            swal({
                ...
                if (result.value) {
                    ...
                    axios.delete('/admin/article/'+id+'/delete').then(function () {
        ...
        $('.btn-del-ad-message').click(function() {
            var id = $(this).data('id');
            swal({
                ...
                if (result.value) {
                    ...
                    axios.delete('/admin/message/'+id+'/delete').then(function () {
                        location.reload();
                    });
                }
            });
